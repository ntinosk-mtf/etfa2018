...
class dict_fuzz_object(object):
    ...
    def __init__(self):
        ...
        self.Dict_fuzz_operation = {
            ...
            'test_FC_23':['1-way_read_starting_address', '1-way_quantity_to_Read','1-way_write_starting_address','1-way_quantity_to_Write','1-way_write_byte_count','2-way'],#ok, 2way
            'test_wr_mask_param':['address','or_mask','and_mask'],
            'test_FC43':['mei_type','read_code','object_id','2-way' ],
            'Diagnostics_FC_param':['sub-function','data','2-way'],
            ...
            'fp': ['test_dumplicate_ADU','test_illegal_len_PDU'],            
            'attack_byte_PDU':['attack_randByte','attack_inter_byte','remove_byte_of_PDU'], 
            'test_class_of_msg' : ['sequence','serial','exception','diagnostics','bad','strings_format','omission']     
        }  
    ...
    def int_fuzz_operation(self):                
            ...
            fuzz_session.test_class_of_msg=self.dict_operation_key('test_class_of_msg')                                    
