...
def run_server():
    ...
    # ----------------------------------------------------------------------- #
    store = ModbusSlaveContext(
        di=ModbusSequentialDataBlock(8192, [1]*1000),
        co=ModbusSequentialDataBlock(2048, [12]*8190),
        hr=ModbusSequentialDataBlock(4096, [14]*16000),
        ir=ModbusSequentialDataBlock(1000, [10]*48000))
