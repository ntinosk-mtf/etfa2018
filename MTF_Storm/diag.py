...
class DiagnosticStatusRequest():
    ...
    def encode(self):
        ...
        '''
        if self.sub_function_code==255:self.sub_function_code=255
        ...
        if self.message is not None:
            if isinstance(self.message, str):
                ...
                if self.message>65535: self.message=65535
...
class DiagnosticStatusResponse():
    '''
...
__all__ = [
    ...
    #"RestartCommunicationsclearRequest","GetClearModbusPlusRequest",
]
